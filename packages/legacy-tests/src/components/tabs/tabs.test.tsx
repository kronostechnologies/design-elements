...
import { actAndWaitForEffects, mountWithProviders, mountWithTheme } from '../../test-utils/renderer';
...
describe('Tabs', () => {
    ...
    it('should only render the selected panel by default', () => {
    ...
    it('tab panel should be rendered when tab is selected', () => {
        const tabs: Tab[] = givenTabs(2);
        const wrapper = mountWithProviders(<Tabs tabs={tabs} />);
    ...
    it('tab panel should unmount when another tab is selected', () => {
        const tabs: Tab[] = givenTabs(2);
        const wrapper = mountWithProviders(<Tabs tabs={tabs} />);
    ...
    it('tab panel should change if no onBeforeUnload callback was provided', async () => {
        const tabs: Tab[] = givenTabs(2);
        tabs[0] = {
            ...tabs[0],
        };
    ...
    it('when a button is selected only the selected panel should be displayed', () => {
        const tabs: Tab[] = givenTabs(2);
        const wrapper = mountWithProviders(<Tabs tabs={tabs} />);

...
import { PasswordCreationInput } from '~/components/password-creation-input/password-creation-input';
import { getPasswordStrength } from '~/components/password-creation-input/password-strength';
import { PasswordStrengthEnum } from '~/components/password-creation-input/password-strength.enum';
import { getByTestId } from '../../test-utils/enzyme-selectors';
import { mountWithProviders } from '../../test-utils/renderer';

jest.mock('~/components/password-creation-input/password-strength', () => ({
...
describe('PasswordCreationInput', () => {
    ...
    it('calls onChange with password and isValid to false when a custom validation is false', () => {
        const onChange = jest.fn();
        const wrapper = shallow(
    ...
    it('calls onChange with password and isValid to true when a custom validation is true', () => {
        const onChange = jest.fn();
        const wrapper = shallow(
            <PasswordCreationInput
                validations={[
    ...
    it('calls onChange with password and isValid to true when password changes to a valid password', () => {
        const onChange = jest.fn();
        const wrapper = shallow(
            <PasswordCreationInput onChange={onChange} />,
        );
    ...
    it('calls onChange with password and isValid to false when password changes to an invalid password', () => {
        const onChange = jest.fn();
        const wrapper = shallow(
            <PasswordCreationInput onChange={onChange} />,
        );
    ...
    it('sets password strength text to weak when strength is weak', () => {
        const onChange = jest.fn();
    ...
    it('sets password strength text to fair when strength is fair', () => {
        const onChange = jest.fn();
    ...
    it('sets password strength text to good when strength is good', () => {
        const onChange = jest.fn();
    ...
    it('sets password strength to strong when strength is strong', () => {
        const onChange = jest.fn();

...
export const iconButtons = () => (
    <>
        ...
        <IconButton label="mapPin" buttonType={'tertiary' as ButtonType} iconName="mapPin"/>
    </>
);
export const mobile = () => (
    <>
        ...
        <IconButton label="mapPin" buttonType={'tertiary' as ButtonType} iconName="mapPin" device="mobile"/>
    </>
);
export const disabled = () => (
    <>
        ...
        <IconButton label="mapPin" buttonType={'tertiary' as ButtonType} iconName="mapPin" disabled/>
    </>
);

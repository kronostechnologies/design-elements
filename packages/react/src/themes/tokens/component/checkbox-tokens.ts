...
export type CheckboxTokens =
    ...
    | 'checkbox-hover-disabled-background-color'
    | 'checkbox-hover-disabled-border-color'
    | 'checkbox-checked-border-color'
    | 'checkbox-checked-background-color'
    | 'checkbox-indeterminiate-border-color'
    | 'checkbox-indeterminiate-background-color'
...
export const defaultCheckboxTokens: CheckboxTokenMap = {
    ...
    'checkbox-checked-text-color': 'color-white',
    ...
    'checkbox-hover-disabled-background-color': 'color-neutral-05',
    'checkbox-hover-disabled-border-color': 'color-neutral-15',
    'checkbox-indeterminiate-background-color': 'color-brand-50',
    'checkbox-indeterminiate-border-color': 'color-brand-50',

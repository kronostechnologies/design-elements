...
export const defaultRadioButtonGroupTokens: RadioButtonGroupTokenMap = {
    'radio-button-background-color': 'color-input-background',
    ...
    'radio-button-disabled-background-color': 'color-input-background-disabled',
    ...
    'radio-button-checked-background-color': 'color-input-background-checked',

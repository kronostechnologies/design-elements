...
export const defaultProgressTrackerTokens: ProgressTrackerTokenMap = {
    ...
    'progress-tracker-notification-badge-fill-color': 'color-feedback-bg-fill-alert',

    'progress-tracker-bridge-empty-background-color': 'color-empty-bg-fill',
    'progress-tracker-bridge-filled-background-color': 'color-indicator-bg-fill',
    // TO-DO
    'progress-tracker-step-todo-text-color': 'color-text',
    'progress-tracker-step-todo-background-color': 'color-bg-fill',
    // Uncompleted
    ...
    // Active
    'progress-tracker-step-active-border-color': 'color-indicator-bg-fill',
    ...
    // Completed
    'progress-tracker-step-completed-background-color': 'color-indicator-bg-fill',
    'progress-tracker-step-completed-border-color': 'color-indicator-bg-fill',

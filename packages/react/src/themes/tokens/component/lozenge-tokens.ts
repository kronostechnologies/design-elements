...
export const defaultLozengeTokens: LozengeTokensMap = {
    'lozenge-neutral-background-color': 'color-bg-inverse',
    'lozenge-neutral-border-color': 'color-bg-inverse',
    'lozenge-neutral-text-color': 'color-text-inverse',
    'lozenge-neutral-subtle-background-color': 'color-bg-alternate-subtle',
    'lozenge-neutral-subtle-border-color': 'color-bg-alternate-subtle',
    'lozenge-neutral-subtle-text-color': 'color-text-alternate',
    'lozenge-info-background-color': 'color-informative-50',
    'lozenge-info-border-color': 'color-informative-50',
    'lozenge-info-text-color': 'color-text-inverse',
    ...
    'lozenge-success-text-color': 'color-text-inverse',
    ...
    'lozenge-discovery-text-color': 'color-text-inverse',
    ...
    'lozenge-alert-text-color': 'color-text-inverse',
    ...
    'lozenge-warning-text-color': 'color-text',

...
import { Container, Disclosure, StyledButton } from './disclosure';
...
describe('Disclosure', () => {
    ...
    it('sets button aria-controls to id generated by useId', () => {
        ...
        expect(wrapper.find(StyledButton).prop('aria-controls')).toBe(idContent);
    });
    ...
    it('toggles expanded state when button is clicked', () => {
        ...
        expect(wrapper.find(StyledButton).prop('aria-expanded')).toBe(true);
        button.simulate('click');
        expect(wrapper.find(StyledButton).prop('aria-expanded')).toBe(false);
    });
    ...
    it('does not render children when button has not been clicked yet', () => {
        ...
        expect(wrapper.find(Container).exists()).toBe(true);
        expect(wrapper.find(Container).contains(childrenContent)).toBe(false);
    });

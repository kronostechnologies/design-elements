...
const ToggletipContainer = styled.div<{ isMobile?: boolean }>`
    ...
    &[data-popper-placement*="bottom"] > ${ToggletipArrow}::before {
        border-color: transparent transparent ${({ theme }) => theme.ref['color-neutral-65']} transparent;
    ...
    &[data-popper-placement*="bottom"] > ${ToggletipArrow}::after {
        border-color: transparent transparent ${({ theme }) => theme.ref['color-white']} transparent;
        border-width: 0 0.5rem 0.4rem;
    }
    ...
    &[data-popper-placement*="top"] > ${ToggletipArrow}::before {
        border-color: ${({ theme }) => theme.ref['color-neutral-65']} transparent transparent transparent;
    ...
    &[data-popper-placement*="top"] > ${ToggletipArrow}::after {
        border-color: ${({ theme }) => theme.ref['color-white']} transparent transparent transparent;
        border-width: 0.4rem 0.5rem 0;
    }
    ...
    &[data-popper-placement*="right"] > ${ToggletipArrow}::before {
        border-color: transparent ${({ theme }) => theme.ref['color-neutral-65']} transparent transparent;
        border-width: 0.5rem 0.4rem 0.5rem 0;
    }

    &[data-popper-placement*="right"] > ${ToggletipArrow}::after {
        border-color: transparent ${({ theme }) => theme.ref['color-white']} transparent transparent;
        border-width: 0.5rem 0.4rem 0.5rem 0;
        left: 0.375rem;
        top: 0;
    }
    ...
    &[data-popper-placement*="left"] > ${ToggletipArrow}::before {
        border-color: transparent transparent transparent ${({ theme }) => theme.ref['color-neutral-65']};
        border-width: 0.5rem 0 0.5rem 0.4rem;
    }

    &[data-popper-placement*="left"] > ${ToggletipArrow}::after {
        border-color: transparent transparent transparent ${({ theme }) => theme.ref['color-white']};
        border-width: 0.5rem 0 0.5rem 0.4rem;
        left: 0.25rem;
        top: 0;
    }

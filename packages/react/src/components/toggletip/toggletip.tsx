...
const ToggletipContainer = styled.div<{ isMobile?: boolean }>`
    ...
    &[data-popper-placement*="bottom"] > ${ToggletipArrow}::before {
        border-color: transparent transparent ${({ theme }) => theme.component['toggletip-arrow-bottom-before-border-color']} transparent;
    ...
    &[data-popper-placement*="bottom"] > ${ToggletipArrow}::after {
        border-color: transparent transparent ${({ theme }) => theme.component['toggletip-arrow-bottom-after-border-color']} transparent;
        border-width: 0 0.5rem 0.4rem;
    }
    ...
    &[data-popper-placement*="top"] > ${ToggletipArrow}::before {
        border-color: ${({ theme }) => theme.component['toggletip-arrow-top-before-border-color']} transparent transparent transparent;
    ...
    &[data-popper-placement*="top"] > ${ToggletipArrow}::after {
        border-color: ${({ theme }) => theme.component['toggletip-arrow-top-after-border-color']} transparent transparent transparent;
        border-width: 0.4rem 0.5rem 0;
    }
    ...
    &[data-popper-placement*="right"] > ${ToggletipArrow}::before {
        border-color: transparent ${({ theme }) => theme.component['toggletip-arrow-right-before-border-color']} transparent transparent;
        border-width: 0.5rem 0.4rem 0.5rem 0;
    }

    &[data-popper-placement*="right"] > ${ToggletipArrow}::after {
        border-color: transparent ${({ theme }) => theme.component['toggletip-arrow-right-after-border-color']} transparent transparent;
        border-width: 0.5rem 0.4rem 0.5rem 0;
        left: 0.375rem;
        top: 0;
    }
